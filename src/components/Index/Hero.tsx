          ...
          <div className="max-w-2xl text-center lg:text-left">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
              <Button
                asChild
                size="lg"
                className="rounded-full bg-forge-orange px-8 text-white hover:bg-forge-orange/90"
              >
                <Link to="/contact">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="rounded-full border-forge-navy/20 px-8 text-forge-navy hover:bg-forge-navy/5"
              >
            ...
            <div className="relative rounded-2xl border border-forge-navy/10 bg-white p-3 shadow-2xl lg:p-4">
              <div className="overflow-hidden rounded-xl bg-muted">
                <img
                  ...
                  src="https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_67d8c08e9c_62edaf4e23e7a399.png"
