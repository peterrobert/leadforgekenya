...
const PROJECTS = [
  {
    ...
    img_url:
      "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_e3a28b4758_d4724c1ffa3b0a0a.png",
  },
  {
    id: "kikuyu-water",
    ...
    img_url:
      "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_5a98854dde_cb8cfb3712a0e4cf.png",
  },
  {
    id: "wisa-guard",
    ...
    img_url:
      "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_1950f2b2c6_3693f5648fa46cc7.png",
  },
  {
    id: "swiftdispatch",
    title: "SwiftDispatch",
    ...
    img_url:
      "https://storage.googleapis.com/uxpilot-auth.appspot.com/gen_4f486afc08_5d3b7b35d8138db0.png",
  },
];
      ...
      <main className="flex-1">
        ...
        <section className="px-4 py-16 md:py-24 lg:py-32">
          <div className="mx-auto max-w-7xl text-center">
            <Badge
              variant="outline"
              className="mb-4 rounded-full border-forge-orange/30 bg-forge-orange/5 px-4 py-1 text-sm font-medium text-forge-orange uppercase tracking-wider"
            >
              Our Work
            </Badge>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {filteredProjects.map((project) => (
                <Fragment key={project.id}>{/* its here */}</Fragment>
              ))}
            </div>
        ...
        <section className="px-4 py-24 md:py-32 bg-forge-navy text-white overflow-hidden relative">
          ...
          <div className="mx-auto max-w-4xl text-center relative z-10">
            ...
            <Button
              asChild
              size="lg"
              className="rounded-full bg-forge-orange px-8 py-6 text-lg font-bold hover:bg-forge-orange/90 shadow-lg shadow-forge-orange/20"
            >
              <Link to="/contact">
